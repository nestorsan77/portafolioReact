const projects = [
  {
    ...
    goals: [
      ...
      "Crear una sincronización con zoho CRM para gestión de clientes",
      "Crear un historial de precios de la energía para el usuario gestionada desde el CRM",
    ],
    duration: "6 meses",
  ...
  },
  {
    ...
    duration: "8 meses",
    role: "Frontend Lead en llevar el desarrollo Nativo en Android y IOS + Backend",
    highlights: [
      "Diseño UI/UX alineado con identidad de marca premium en Swift y Kotlin",
  ...
  },
  {
    ...
    highlights: [
      "Demostrar mis habilidades en PHP y MySQL",
      "Responsive y fácil de usar",
      "Panel de administración funcional con login",
    ],
  },
  {
